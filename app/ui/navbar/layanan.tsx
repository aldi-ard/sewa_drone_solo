  ...
  return (
    <section className=' w-full h-auto p-12 bg-gray-100'>
        <div className='max-w-6xl mx-auto'>
            <h2 className='text-center font-extrabold text-4xl mt-6 mb-9'>Layanan Kami</h2>
            ...
            <div className="flex flex-col md:flex-row sm:flex-wrap w-full sm:gap-0  h-auto pt-8 items-center mx-auto justify-between ">
              <Card
                  title='Sewa Drone'
