    ...
    return(
      <div className="relative h-screen text-white overflow-hidden pb-24 mb:4 md:pb=8">
        <div className="absolute inset-0" > 
            <Image src={'/background.jpg'} alt="hero-jpg" fill className="object-cover object-center w-full h-full"/>
        </div>
        ...
        <div className="relative flex flex-col justify-center items-center h-full mt-64 text-center md:mt-64 md:pt-30">
          <h1 className="text-3xl md:text-5xl text-balance font-extrabold leading-tight text-white text-shadow-amber-50 mb-1 md:mb-3 capitalize">jasa sewa drone solo</h1>
          <p className="text-md h-auto text-wrap w-full md:max-w-6xl px-6 text-white  shadow-blue-50 mb-8 md:mx-80 md:px-60 font-extralight">
