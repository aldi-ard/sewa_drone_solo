...
function page() {
  return (
    <section className=' w-full h-auto md:p-12 bg-gray-100 pt-24'>
        <div className='max-w-6xl p-12 md:px-0 mx-auto'>
        ...
        <div className='md:max-w-6xl w-full md:mx-auto border-t mt-16 md:mt-2 pt-10 bg-transparent'>
