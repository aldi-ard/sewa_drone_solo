  ...
  return (
    <section className=' w-full h-auto p-12 bg-gray-100'>
        <div className='max-w-6xl mx-auto'>
            ...
            <div className="w-full border-b pb-5 mb-5 mt-5">
                <h2 className="font-semibold text-xl capitalize">paket drone aerial</h2>
            </div>
            <div className="flex flex-col md:flex-row sm:flex-wrap w-full sm:gap-0  h-auto pt-8 items-center mx-auto md:gap-8 flex-wrap">
              <Card
                  title='Sewa Drone'
